...
public record ClosePoint(float len2, PathRenderer parentTrajectoryPathRenderer, int index) implements Comparable<ClosePoint> {
     ...
     */
    @Override
    public int compareTo(@NotNull ClosePoint o) {
