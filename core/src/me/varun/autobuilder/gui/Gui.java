...
public class Gui implements MouseScrollEventHandler {
    ...
    @NotNull AddPathButton addPathButton = new AddPathButton(0,0, 40, 40);
    @NotNull AddScriptButton addScriptButton = new AddScriptButton(0,0, 40, 40);
    ...
    public void render(@NotNull RoundedShapeRenderer shapeRenderer, @NotNull SpriteBatch spriteBatch, @NotNull Camera camera) {
        ...
        for (AbstractGuiItem guiItem : guiItems) {
            yPos = yPos - 10 - guiItem.render(shapeRenderer, panelX + 10 , yPos, panelWidth - 20);
        }
        shapeRenderer.flush();
